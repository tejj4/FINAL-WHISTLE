    ...
    knockoutRounds: [
      {
        ...
        matches: [
          { id:'wc_r32_0',  date:'2026-06-28', homeSource:{type:'group',groupId:'A',pos:1}, awaySource:{type:'group',groupId:'B',pos:2} },
          { id:'wc_r32_1',  date:'2026-06-28', homeSource:{type:'group',groupId:'C',pos:2}, awaySource:{type:'group',groupId:'D',pos:1} },
          { id:'wc_r32_2',  date:'2026-06-28', homeSource:{type:'group',groupId:'B',pos:1}, awaySource:{type:'group',groupId:'A',pos:2} },
          { id:'wc_r32_3',  date:'2026-06-28', homeSource:{type:'group',groupId:'D',pos:2}, awaySource:{type:'group',groupId:'C',pos:1} },
          { id:'wc_r32_4',  date:'2026-06-29', homeSource:{type:'group',groupId:'E',pos:1}, awaySource:{type:'group',groupId:'F',pos:2} },
          { id:'wc_r32_5',  date:'2026-06-29', homeSource:{type:'group',groupId:'G',pos:2}, awaySource:{type:'group',groupId:'H',pos:1} },
          { id:'wc_r32_6',  date:'2026-06-29', homeSource:{type:'group',groupId:'F',pos:1}, awaySource:{type:'group',groupId:'E',pos:2} },
          { id:'wc_r32_7',  date:'2026-06-29', homeSource:{type:'group',groupId:'H',pos:2}, awaySource:{type:'group',groupId:'G',pos:1} },
          { id:'wc_r32_8',  date:'2026-06-30', homeSource:{type:'group',groupId:'I',pos:1}, awaySource:{type:'group',groupId:'J',pos:2} },
          { id:'wc_r32_9',  date:'2026-06-30', homeSource:{type:'group',groupId:'K',pos:2}, awaySource:{type:'group',groupId:'L',pos:1} },
          { id:'wc_r32_10', date:'2026-06-30', homeSource:{type:'group',groupId:'J',pos:1}, awaySource:{type:'group',groupId:'I',pos:2} },
          { id:'wc_r32_11', date:'2026-06-30', homeSource:{type:'group',groupId:'L',pos:2}, awaySource:{type:'group',groupId:'K',pos:1} },
          { id:'wc_r32_12', date:'2026-07-01', homeSource:{type:'best3rd',rank:1}, awaySource:{type:'best3rd',rank:2} },
          { id:'wc_r32_13', date:'2026-07-01', homeSource:{type:'best3rd',rank:3}, awaySource:{type:'best3rd',rank:4} },
          { id:'wc_r32_14', date:'2026-07-01', homeSource:{type:'best3rd',rank:5}, awaySource:{type:'best3rd',rank:6} },
          { id:'wc_r32_15', date:'2026-07-01', homeSource:{type:'best3rd',rank:7}, awaySource:{type:'best3rd',rank:8} },
        ],
      },
      {
        id:'r16', name:'Round of 16',
        matches: [
          { id:'wc_r16_0', date:'2026-07-04', homeSource:{type:'match',matchId:'wc_r32_0'},  awaySource:{type:'match',matchId:'wc_r32_1'}  },
          { id:'wc_r16_1', date:'2026-07-04', homeSource:{type:'match',matchId:'wc_r32_2'},  awaySource:{type:'match',matchId:'wc_r32_3'}  },
          { id:'wc_r16_2', date:'2026-07-05', homeSource:{type:'match',matchId:'wc_r32_4'},  awaySource:{type:'match',matchId:'wc_r32_5'}  },
          { id:'wc_r16_3', date:'2026-07-05', homeSource:{type:'match',matchId:'wc_r32_6'},  awaySource:{type:'match',matchId:'wc_r32_7'}  },
          { id:'wc_r16_4', date:'2026-07-06', homeSource:{type:'match',matchId:'wc_r32_8'},  awaySource:{type:'match',matchId:'wc_r32_9'}  },
          { id:'wc_r16_5', date:'2026-07-06', homeSource:{type:'match',matchId:'wc_r32_10'}, awaySource:{type:'match',matchId:'wc_r32_11'} },
          { id:'wc_r16_6', date:'2026-07-07', homeSource:{type:'match',matchId:'wc_r32_12'}, awaySource:{type:'match',matchId:'wc_r32_13'} },
          { id:'wc_r16_7', date:'2026-07-07', homeSource:{type:'match',matchId:'wc_r32_14'}, awaySource:{type:'match',matchId:'wc_r32_15'} },
        ],
      },
      {
        id:'qf', name:'Quarter-Finals',
        matches: [
          { id:'wc_qf_0', date:'2026-07-11', homeSource:{type:'match',matchId:'wc_r16_0'}, awaySource:{type:'match',matchId:'wc_r16_1'} },
          { id:'wc_qf_1', date:'2026-07-11', homeSource:{type:'match',matchId:'wc_r16_2'}, awaySource:{type:'match',matchId:'wc_r16_3'} },
          { id:'wc_qf_2', date:'2026-07-12', homeSource:{type:'match',matchId:'wc_r16_4'}, awaySource:{type:'match',matchId:'wc_r16_5'} },
          { id:'wc_qf_3', date:'2026-07-12', homeSource:{type:'match',matchId:'wc_r16_6'}, awaySource:{type:'match',matchId:'wc_r16_7'} },
        ],
      },
      {
        id:'sf', name:'Semi-Finals',
        matches: [
          { id:'wc_sf_0', date:'2026-07-15', homeSource:{type:'match',matchId:'wc_qf_0'}, awaySource:{type:'match',matchId:'wc_qf_1'} },
          { id:'wc_sf_1', date:'2026-07-16', homeSource:{type:'match',matchId:'wc_qf_2'}, awaySource:{type:'match',matchId:'wc_qf_3'} },
        ],
      },
      {
        id:'f', name:'Final',
        matches:[{ id:'wc_final', date:'2026-07-19', homeSource:{type:'match',matchId:'wc_sf_0'}, awaySource:{type:'match',matchId:'wc_sf_1'} }],
      },
    ],
    // Real match dates (all 72 group stage fixtures) + actual scores for played matches.
    // Keys: 'homeId:awayId' from official schedule. Lookup tries fwd then bwd (flipping scores).
    matchData: {
      // Group A — Mexico, South Africa, South Korea, Czech Republic
      'wc_mex:wc_rsa': { date:'2026-06-11', home:2, away:0 },
      'wc_kor:wc_cze': { date:'2026-06-12', home:2, away:1 },
      'wc_cze:wc_rsa': { date:'2026-06-18' },
      'wc_mex:wc_kor': { date:'2026-06-18' },
      'wc_rsa:wc_kor': { date:'2026-06-25' },
      'wc_cze:wc_mex': { date:'2026-06-25' },
      // Group B — Canada, Bosnia & Herzegovina, Qatar, Switzerland
      'wc_can:wc_bih': { date:'2026-06-12', home:1, away:1 },
      'wc_qat:wc_sui': { date:'2026-06-12' },
      'wc_sui:wc_bih': { date:'2026-06-18' },
      'wc_can:wc_qat': { date:'2026-06-18' },
      'wc_sui:wc_can': { date:'2026-06-24' },
      'wc_bih:wc_qat': { date:'2026-06-24' },
      // Group C — Brazil, Morocco, Haiti, Scotland
      'wc_bra:wc_mar': { date:'2026-06-13' },
      'wc_hai:wc_sco': { date:'2026-06-14' },
      'wc_sco:wc_mar': { date:'2026-06-19' },
      'wc_bra:wc_hai': { date:'2026-06-20' },
      'wc_mar:wc_hai': { date:'2026-06-24' },
      'wc_sco:wc_bra': { date:'2026-06-24' },
      // Group D — USA, Paraguay, Australia, Turkey
      'wc_usa:wc_par': { date:'2026-06-13', home:4, away:1 },
      'wc_aus:wc_tur': { date:'2026-06-14' },
      'wc_usa:wc_aus': { date:'2026-06-19' },
      'wc_tur:wc_par': { date:'2026-06-20' },
      'wc_tur:wc_usa': { date:'2026-06-26' },
      'wc_par:wc_aus': { date:'2026-06-26' },
      // Group E — Germany, Curacao, Ivory Coast, Ecuador
      'wc_ger:wc_cur': { date:'2026-06-14' },
      'wc_civ:wc_ecu': { date:'2026-06-15' },
      'wc_ger:wc_civ': { date:'2026-06-20' },
      'wc_ecu:wc_cur': { date:'2026-06-21' },
      'wc_cur:wc_civ': { date:'2026-06-25' },
      'wc_ecu:wc_ger': { date:'2026-06-25' },
      // Group F — Netherlands, Japan, Sweden, Tunisia
      'wc_ned:wc_jpn': { date:'2026-06-14' },
      'wc_swe:wc_tun': { date:'2026-06-15' },
      'wc_ned:wc_swe': { date:'2026-06-20' },
      'wc_tun:wc_jpn': { date:'2026-06-21' },
      'wc_tun:wc_ned': { date:'2026-06-26' },
      'wc_jpn:wc_swe': { date:'2026-06-26' },
      // Group G — Belgium, Egypt, Iran, New Zealand
      'wc_bel:wc_egy': { date:'2026-06-15' },
      'wc_irn:wc_nzl': { date:'2026-06-15' },
      'wc_bel:wc_irn': { date:'2026-06-21' },
      'wc_nzl:wc_egy': { date:'2026-06-21' },
      'wc_nzl:wc_bel': { date:'2026-06-27' },
      'wc_egy:wc_irn': { date:'2026-06-27' },
      // Group H — Spain, Cape Verde, Saudi Arabia, Uruguay
      'wc_esp:wc_cpv': { date:'2026-06-15' },
      'wc_ksa:wc_uru': { date:'2026-06-15' },
      'wc_esp:wc_ksa': { date:'2026-06-21' },
      'wc_uru:wc_cpv': { date:'2026-06-21' },
      'wc_cpv:wc_ksa': { date:'2026-06-27' },
      'wc_uru:wc_esp': { date:'2026-06-27' },
      // Group I — France, Senegal, Iraq, Norway
      'wc_fra:wc_sen': { date:'2026-06-16' },
      'wc_irq:wc_nor': { date:'2026-06-16' },
      'wc_fra:wc_irq': { date:'2026-06-22' },
      'wc_nor:wc_sen': { date:'2026-06-23' },
      'wc_nor:wc_fra': { date:'2026-06-26' },
      'wc_sen:wc_irq': { date:'2026-06-26' },
      // Group J — Argentina, Algeria, Austria, Jordan
      'wc_arg:wc_alg': { date:'2026-06-17' },
      'wc_aut:wc_jor': { date:'2026-06-17' },
      'wc_arg:wc_aut': { date:'2026-06-22' },
      'wc_jor:wc_alg': { date:'2026-06-23' },
      'wc_alg:wc_aut': { date:'2026-06-28' },
      'wc_jor:wc_arg': { date:'2026-06-28' },
      // Group K — Portugal, DR Congo, Uzbekistan, Colombia
      'wc_por:wc_cod': { date:'2026-06-17' },
      'wc_uzb:wc_col': { date:'2026-06-18' },
      'wc_por:wc_uzb': { date:'2026-06-23' },
      'wc_col:wc_cod': { date:'2026-06-24' },
      'wc_col:wc_por': { date:'2026-06-28' },
      'wc_cod:wc_uzb': { date:'2026-06-28' },
      // Group L — England, Croatia, Ghana, Panama
      'wc_eng:wc_cro': { date:'2026-06-17' },
      'wc_gha:wc_pan': { date:'2026-06-18' },
      'wc_eng:wc_gha': { date:'2026-06-23' },
      'wc_pan:wc_cro': { date:'2026-06-24' },
      'wc_pan:wc_eng': { date:'2026-06-27' },
      'wc_cro:wc_gha': { date:'2026-06-27' },
    },
  },
