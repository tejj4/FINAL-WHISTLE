...
export const competitors = {
  ...
  // ── FIFA World Cup 2026 national teams (48) ──────────────────────────────
  // Group A
  wc_usa: { id:'wc_usa', name:'USA',         abbr:'USA', bg:'#B22234', fg:'#fff', strength:76 },
  wc_eng: { id:'wc_eng', name:'England',     abbr:'ENG', bg:'#012169', fg:'#fff', strength:87 },
  wc_mar: { id:'wc_mar', name:'Morocco',     abbr:'MAR', bg:'#C1272D', fg:'#fff', strength:80 },
  wc_nzl: { id:'wc_nzl', name:'New Zealand', abbr:'NZL', bg:'#00247D', fg:'#fff', strength:62 },
  // Group B
  wc_mex: { id:'wc_mex', name:'Mexico',      abbr:'MEX', bg:'#006847', fg:'#fff', strength:75 },
  ...
  wc_idn: { id:'wc_idn', name:'Indonesia',   abbr:'IDN', bg:'#CE1126', fg:'#fff', strength:61 },
  // Group C
  ...
  wc_cmr: { id:'wc_cmr', name:'Cameroon',    abbr:'CMR', bg:'#007A3D', fg:'#CE1126', strength:70 },
  ...
  wc_nga: { id:'wc_nga', name:'Nigeria',     abbr:'NGA', bg:'#008751', fg:'#fff', strength:72 },
  wc_jpn: { id:'wc_jpn', name:'Japan',       abbr:'JPN', bg:'#BC002D', fg:'#fff', strength:74 },
  // Group F
  ...
  wc_alg: { id:'wc_alg', name:'Algeria',     abbr:'ALG', bg:'#006233', fg:'#fff', strength:71 },
  ...
  wc_can: { id:'wc_can', name:'Canada',      abbr:'CAN', bg:'#FF0000', fg:'#fff', strength:74 },
  // Group H
  wc_den: { id:'wc_den', name:'Denmark',     abbr:'DEN', bg:'#C60C30', fg:'#fff', strength:80 },
  ...
  wc_hon: { id:'wc_hon', name:'Honduras',    abbr:'HON', bg:'#0073CF', fg:'#fff', strength:63 },
  // Group I
  wc_ita: { id:'wc_ita', name:'Italy',       abbr:'ITA', bg:'#009246', fg:'#fff', strength:84 },
  wc_chi: { id:'wc_chi', name:'Chile',       abbr:'CHI', bg:'#D52B1E', fg:'#fff', strength:74 },
  wc_mli: { id:'wc_mli', name:'Mali',        abbr:'MLI', bg:'#14B53A', fg:'#fff', strength:68 },
  ...
  wc_ven: { id:'wc_ven', name:'Venezuela',   abbr:'VEN', bg:'#CF142B', fg:'#fff', strength:66 },
  wc_tun: { id:'wc_tun', name:'Tunisia',     abbr:'TUN', bg:'#E70013', fg:'#fff', strength:68 },
  wc_crc: { id:'wc_crc', name:'Costa Rica',  abbr:'CRC', bg:'#002B7F', fg:'#CE1126', strength:66 },
  // Group K
  ...
  wc_tur: { id:'wc_tur', name:'Turkey',      abbr:'TUR', bg:'#E30A17', fg:'#fff', strength:77 },
  wc_uzb: { id:'wc_uzb', name:'Uzbekistan',  abbr:'UZB', bg:'#1EB53A', fg:'#fff', strength:65 },
  // Group L
  wc_pol: { id:'wc_pol', name:'Poland',      abbr:'POL', bg:'#DC143C', fg:'#fff', strength:75 },
  wc_srb: { id:'wc_srb', name:'Serbia',      abbr:'SRB', bg:'#C6363C', fg:'#fff', strength:75 },
  wc_sco: { id:'wc_sco', name:'Scotland',    abbr:'SCO', bg:'#003DA5', fg:'#fff', strength:72 },
  wc_jor: { id:'wc_jor', name:'Jordan',      abbr:'JOR', bg:'#007A3D', fg:'#fff', strength:61 },
  ...
  epl_lei: { id:'epl_lei', name:'Leicester',       abbr:'LEI', bg:'#003090', fg:'#FDBE11', strength:71 },
  epl_ips: { id:'epl_ips', name:'Ipswich',         abbr:'IPS', bg:'#0044A9', fg:'#fff',    strength:68 },
  epl_sou: { id:'epl_sou', name:'Southampton',     abbr:'SOU', bg:'#D71920', fg:'#fff',    strength:67 },
  ...
  ll_val2:{ id:'ll_val2',name:'Valladolid',       abbr:'VAD', bg:'#9400D3', fg:'#fff',    strength:67 },
  ll_leg: { id:'ll_leg', name:'Leganés',          abbr:'LEG', bg:'#003087', fg:'#5FA8D3', strength:66 },
  ...
  w_alca: { id:'w_alca', name:'C. Alcaraz',   abbr:'ALC', bg:'#E85D04', fg:'#fff', strength:97 },
  w_sin:  { id:'w_sin',  name:'J. Sinner',    abbr:'SIN', bg:'#2D6A4F', fg:'#fff', strength:96 },
...
export const tournaments = [
  ...
  // ════════════════════════════════════════════════════════════════
  {
    ...
    formatType: 'groups',
    groups: [
      { id:'A', name:'Group A', competitorIds:['wc_usa','wc_eng','wc_mar','wc_nzl'] },
      { id:'B', name:'Group B', competitorIds:['wc_mex','wc_ger','wc_sen','wc_idn'] },
      { id:'C', name:'Group C', competitorIds:['wc_arg','wc_fra','wc_civ','wc_aus'] },
      { id:'D', name:'Group D', competitorIds:['wc_bra','wc_esp','wc_cmr','wc_kor'] },
      { id:'E', name:'Group E', competitorIds:['wc_por','wc_ned','wc_nga','wc_jpn'] },
      { id:'F', name:'Group F', competitorIds:['wc_bel','wc_col','wc_alg','wc_ksa'] },
      { id:'G', name:'Group G', competitorIds:['wc_cro','wc_uru','wc_egy','wc_can'] },
      { id:'H', name:'Group H', competitorIds:['wc_den','wc_ecu','wc_gha','wc_hon'] },
      { id:'I', name:'Group I', competitorIds:['wc_ita','wc_chi','wc_mli','wc_irn'] },
      { id:'J', name:'Group J', competitorIds:['wc_sui','wc_ven','wc_tun','wc_crc'] },
      { id:'K', name:'Group K', competitorIds:['wc_aut','wc_pan','wc_tur','wc_uzb'] },
      { id:'L', name:'Group L', competitorIds:['wc_pol','wc_srb','wc_sco','wc_jor'] },
    ],
  ...
  // ════════════════════════════════════════════════════════════════
  {
    ...
    competitorIds: [
      ...
      'epl_wol','epl_eve','epl_lei','epl_ips','epl_sou',
    ],
  },
  ...
  // ════════════════════════════════════════════════════════════════
  {
    ...
    competitorIds: [
      ...
      'll_lpa','ll_esp','ll_ala','ll_val2','ll_leg',
    ],
  },
    ...
    rounds: [
      {
        ...
        matches: [
          ...
          { id:'wim_r32_0',  homeId:'w_alca', awayId:'w_laj'  },
          ...
          { id:'wim_r32_15', homeId:'w_sin',  awayId:'w_fog'  },
        ],
      },
